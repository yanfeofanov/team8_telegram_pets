...
public enum Commands {
    ...
    CAT_SHELTER_MENU("меню с информацией о приюте", "cat_shelter_menu"),
    DOG_SHELTER_MENU("меню с информацией о приюте", "dog_shelter_menu"),
    ...
    SEND_PET_REPORT("отправить отчет о питомце", "/send_pet_report"),
